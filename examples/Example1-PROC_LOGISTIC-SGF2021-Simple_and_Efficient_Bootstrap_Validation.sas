...
Example 1: PROC LOGISTIC - Invited Paper -  SAS Global Forum 2021

This notebook contains an executable version of the example in Section 2 of the paper at https://github.com/saspy-bffs/sgf-2021-bootstrap-validation.
*/
...
See page 4 of the paper at https://github.com/saspy-bffs/sgf-2021-bootstrap-validation. Only PROC LOGISTIC output should be created.
*/
...
See page 6 of the paper at https://github.com/saspy-bffs/sgf-2021-bootstrap-validation. Only SAS log output should be created.
*/
